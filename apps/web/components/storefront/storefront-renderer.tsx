...
async function resolveSectionData(section: SectionConfig, tenantId: string, slug: string, templateId?: string) {
  ...
  switch (section.type) {
    ...
    case SECTION_TYPES.MEGA_MENU: {
      ...
      return { categories: resolveSectionCategories(categories, demoPayload.categories, limit, overrides) };
    }
    ...
    case SECTION_TYPES.LOOKBOOK: {
      ...
      return { products: resolveSectionProducts(products, demoPayload.products, limit, overrides) };
    }
