  ...
  return (
    <header className="h-16 border-b border-slate-200 bg-white sticky top-0 z-30 flex items-center justify-between px-3 sm:px-6">
        ...
        <div className="relative min-w-0">
          ...
          >
            ...
            <div className="flex flex-col leading-tight min-w-0">
              ...
              <span className="text-2xs text-slate-400 font-normal hidden sm:block">GSTIN: 09AAECR1234F1Z5</span>
            </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
        {/* Search Trigger */}
        <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-400 text-xs w-52 lg:w-64 hover:border-slate-300 transition cursor-pointer">
