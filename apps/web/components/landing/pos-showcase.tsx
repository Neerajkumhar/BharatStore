          ...
          <AnimationWrapper animation="fade-up">
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Link
                  href="/dashboard/pos"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-extrabold text-sm shadow-lg shadow-amber-500/25 transition hover:shadow-amber-500/35 hover:-translate-y-0.5"
                >
