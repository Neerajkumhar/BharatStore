...
<div className="flex flex-wrap items-center gap-2 mb-1">
      ...
      {/* Navigation Sub-Tabs */}
<div className="border-b border-slate-200 bg-white rounded-t-xl px-2 pt-2 flex items-center overflow-x-auto gap-1 scrollbar-none max-w-full" tabIndex={0} aria-label="Analytics sections (scrollable horizontally)">
