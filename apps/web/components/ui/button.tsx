...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  accent:
    'bg-amber-500 text-slate-950 hover:bg-amber-400 focus-visible:ring-2 focus-visible:ring-amber-600 focus-visible:ring-offset-2 active:bg-amber-300 shadow-xs border border-transparent',
  outline:
